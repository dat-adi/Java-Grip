...
class ClubRegistration
{
    public static void main(String[] args)
    {
        ...
        String[] registrationNumber = new String[10];
        ...
        do
        {
            ...
            switch(cs)
            {
                ...
                case 2:
                {
                    ...
                    for(i = n - 1; i < n; i++)
                    {
                        registrationNumber[i] = sc.nextLine();
                    }
                    sc.nextLine();
                    flag = 0;
                    while(flag == 0)
                ...
                case 3:
                {
                    if(n > 0)
                    {
                        ...
                        for(i = 0; i < n; i++)
                        {
                            ...
                            System.out.println("Registration Number : " + registrationNumber[i]);
